...
```bash
uv run scripts/fetch_circleci_failures.py
```

**Fetch specific pipeline/workflow:**
```bash
uv run scripts/fetch_circleci_failures.py --pipeline <pipeline-id>
```

**Fetch different branch:**
```bash
uv run scripts/fetch_circleci_failures.py --branch main
```

**Specify project explicitly:**
```bash
uv run scripts/fetch_circleci_failures.py --project gh/owner/repo
```
...
uv run scripts/fetch_circleci_failures.py --project gh/owner/repo --pipeline 456
```
