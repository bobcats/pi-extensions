...
```bash
uv run scripts/fetch_buildkite_failures.py
```

**Fetch specific build:**
```bash
uv run scripts/fetch_buildkite_failures.py --build 1723
```

**Fetch different branch:**
```bash
uv run scripts/fetch_buildkite_failures.py --branch main
```

**Fetch from specific pipeline:**
```bash
uv run scripts/fetch_buildkite_failures.py --pipeline my-pipeline
```
...
uv run scripts/fetch_buildkite_failures.py --build 1234
```
